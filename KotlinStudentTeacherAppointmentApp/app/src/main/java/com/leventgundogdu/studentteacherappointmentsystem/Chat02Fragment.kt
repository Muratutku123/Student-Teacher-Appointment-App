...
class Chat02Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val userName = "muratutku.sayin@std.yeditepe.edu.tr"
        ...
        binding.sendButton.setOnClickListener {
            ...
            auth.currentUser?.let {
                ...
                firestore.collection("$user ile $userName").add(dataMap).addOnSuccessListener {
        ...
        firestore.collection("$user ile $userName").orderBy("date",Query.Direction.ASCENDING).addSnapshotListener { value, error ->
            if (error != null) {
